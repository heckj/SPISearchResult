...
final class SPISearchResultTests: XCTestCase {
    let samplePackageResult = SearchResultPackage(id: PackageId(owner: "heckj", repository: "SPISearchResult"), keywords_matched: [], summary: "A package that defines the transfer objects to capture a collection of Search Results from Swift Package Index", stars: 1)
